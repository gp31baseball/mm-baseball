  ...
  const programs = [
    {
      ...
      icon: "/icons/pitching.jpg", // ✅ updated file extension
      href: "/pitching", // ✅ direct working route
    },
    {
      id: "hitting",
      ...
      icon: "/icons/hitting.jpg", // ✅ updated file extension
      href: "/hitting", // ✅ direct working route
    },
    {
      id: "video",
      title: "Video Breakdown",
      desc: "Personalized swing and mechanics analysis through slow-motion review, annotations, and measurable feedback for improvement tracking.",
      icon: "/icons/video.jpg", // ✅ updated file extension
      href: "/video-breakdown", // ✅ direct working route
    },
  ];
